...
form.addEventListener('submit', function (e) {
    ...
    fetch(url).then((response) => {
        ...
        if (weatherMain == 'Clear') {
            image.src = `https://w7.pngwing.com/pngs/540/96/png-transparent-clouds-sunny-warm-patches-weather-partly-cloudy-symbols-forecast-thumbnail.png`
            myWeatherContainer.style.backgroundColor = '#ec6e4c'
        }
        if (weatherMain == 'Clouds') {
            image.src = `https://cdn.vectorstock.com/i/1000v/90/60/cloudy-weather-vector-2969060.jpg`
            myWeatherContainer.style.backgroundColor = '#86d3d3'
        }
        if (weatherMain == 'Rain') {
            image.src = `https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQZVhXe_7znimLWurrzfR5F1qTWzCogQ-TrA0ZQNuAnlj-fneBgNN9WtBL7BpupGpmsXps&usqp=CAU`
        ...
        if (weatherMain == 'Haze') {
            image.src = `https://png.pngtree.com/png-clipart/20190905/original/pngtree-haze-weather-pollution-illustration-png-image_4507733.jpg`
